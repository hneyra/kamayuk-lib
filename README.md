...
| [`@kamayuk/ui`](paquetes/ui) | los 42 tokens, cuatro identidades por dos modos, las piezas de shadcn y el intérprete de pantallas | **Existe.** <!-- cifras:ui -->**543 pruebas** en 25 archivos, más las **3** de capa<!-- /cifras --> |
...
| [`@kamayuk/verificaciones`](paquetes/verificaciones) | las barreras, sus muestras y el **arnés del `Request`** que los cinco necesitan para correr con Node 24 | **Existe.** <!-- cifras:verificaciones -->**262 pruebas** en 18 archivos<!-- /cifras --> |
