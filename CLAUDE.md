...
paquetes/
  ...
  verificaciones/  texto.ts, suposiciones.ts, marcas.ts, rama-del-consumidor.mjs,
                   las-acciones-corren-en-node-24.test.ts, sus pruebas y sus muestras/
docs/
