...
paquetes/
  ...
  verificaciones/  texto.ts, comentarios.mjs, suposiciones.ts, marcas.ts, rama-del-consumidor.mjs,
                   arnes-del-request.ts (el arnes que se publica) y el-arnes-del-request-no-se-copia.mjs
                   (el guion que el consumidor corre contra su arbol), sus pruebas y sus muestras/
docs/
