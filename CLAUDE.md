...
| [`paquetes/verificaciones`](paquetes/verificaciones/README.md) — `@kamayuk/verificaciones` | **Existe.** Las prohibiciones de ESLint con sus muestras, las guardas del árbol, los guiones de la CI y el arnés del `Request`. <!-- cifras:verificaciones -->**257 pruebas** en 17 archivos<!-- /cifras -->. Le faltan los tokens contra el artboard y el contraste |
...
<!-- cifras:total -->**En total: 1224 pruebas en 63 archivos, más las 3 de capa.**<!-- /cifras -->
