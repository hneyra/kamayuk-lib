...
| [`paquetes/sesion`](paquetes/sesion/README.md) — `@kamayuk/sesion` | **Existe.** `crearIdentidad` con PKCE S256, la sonda del emisor y `quienEntro()`; `peldanoDe()` con sus nueve peldaños y sus palabras como dato. <!-- cifras:sesion -->**120 pruebas** en 3 archivos<!-- /cifras --> |
...
<!-- cifras:total -->**En total: 1207 pruebas en 62 archivos, más las 3 de capa.**<!-- /cifras -->
