...
| [`paquetes/verificaciones`](paquetes/verificaciones/README.md) — `@kamayuk/verificaciones` | **Existe.** Las prohibiciones de ESLint con sus muestras, las guardas del árbol, los guiones de la CI y el arnés del `Request`. <!-- cifras:verificaciones -->**285 pruebas** en 19 archivos<!-- /cifras -->. Le faltan los tokens contra el artboard y el contraste |
...
<!-- cifras:total -->**En total: 1341 pruebas en 70 archivos, más las 3 de capa.**<!-- /cifras -->
...
paquetes/
  ...
  verificaciones/  texto.ts, comentarios.mjs, archivos.mjs (el recorredor, el escaner de lineas y el
                   ...
                   imports.mjs (lo que importa un archivo, por el analizador de TypeScript)
...
| — | **Ningún paquete se importa por su nombre público** | `sin-nombre-publico-entre-paquetes`, con su muestra. Mira el **especificador** que saca el analizador de TypeScript (`imports.mjs`), no la línea: ve el import de efecto, el dinámico y el subcamino (#112) |
