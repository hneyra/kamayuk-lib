...
| [`paquetes/api`](paquetes/api/README.md) — `@kamayuk/api` | **Existe.** `crearCliente` y sus cuatro operaciones —`solicitar`, `solicitarRespuesta`, `descargar` y `subir`—, `entregarAlNavegador` y `ErrorDeLaApi` con las cinco extensiones del contrato. <!-- cifras:api -->**134 pruebas** en 6 archivos<!-- /cifras --> |
...
<!-- cifras:total -->**En total: 1214 pruebas en 63 archivos, más las 3 de capa.**<!-- /cifras -->
