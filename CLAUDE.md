...
| [`paquetes/sesion`](paquetes/sesion/README.md) — `@kamayuk/sesion` | **Existe.** `crearIdentidad` con PKCE S256, la sonda del emisor y `quienEntro()`; `peldanoDe()`, una tabla de reglas con sus nueve peldaños y sus palabras como dato. <!-- cifras:sesion -->**150 pruebas** en 3 archivos<!-- /cifras --> |
...
<!-- cifras:total -->**En total: 1337 pruebas en 70 archivos, más las 3 de capa.**<!-- /cifras -->
...
paquetes/
  ...
  sesion/    identidad.ts (crearIdentidad), quien-entro.ts (leerQuienEntro),
             ...
             textos.ts (los sacos de la escalera y de la puerta)
