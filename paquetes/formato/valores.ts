...
/**
 * El tono de una insignia. Son cuatro, y los cuatro artboards del producto
 * dibujan los mismos cuatro.
 *
 * En castellano, aunque tres de los cuatro sistemas los tengan hoy escritos en
 * ingles (`warn`, `bad`) o con prefijo (`ins-warn`): medido el 2026-09-12, los
 * ocho colores de insignia son **el mismo valor** en los cuatro bajo **tres**
 * nomenclaturas distintas — 32 declaraciones para 8 colores. Esta es la que
 * queda.
 *
 * Un tono **nunca** viaja solo: `Insignia` exige tambien el texto, porque un
 * estado que se comunica solo por color no se comunica a quien no distingue ese
 * color.
 */
