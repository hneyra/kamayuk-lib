 ...
 *
 * Que las tres longitudes sigan siendo las que el artboard de cada sistema dibuja lo comprueba
 * ESE sistema, leyendo su propio `.dc.html`: un artboard es de uno y este paquete es de los
 * cuatro. Lo que se prueba aqui es el COMPORTAMIENTO: que un tipo desconocido reviente en vez
 * de suponer ocho, que la limpieza recorte a la longitud de su tipo y que «completo» sea exacto
 * y no «al menos».
 */
